# 📦 Contributing to Bert XIV

Here is a guide to get started contributing to Bert XIV.

## 🐛 Reporting Bugs

If you spot a bug in any code, please create a GitHub issue on the Bert XIV repository and include as much detail as possible. Make sure to include the following:
...
[Submit a pull request](https://github.com/FRC-4750-Bishop-Eustace/Bert-XIV/pull/new)
...
2. Run the `sim.sh` and `test.sh` scripts after making any changes.

## 📝 Licensing

Bert XIV is released under the [MIT License](https://opensource.org/licenses/MIT).
By contributing to Bert XIV, all of your contributions will be licensed under and you agree to all the terms of a [MIT License](https://opensource.org/licenses/MIT).
